    ...
    container.innerHTML = articles.map(function(article, index) {
        ...
        if (imgUrl) {
            imgHtml = '<a href="' + getArticleUrl(article) + '" style="display:block;width:100%;height:180px;">' +
                '<img src="' + imgUrl + '" alt="' + escapeHtml(article.title) + '"' +
                ' onerror="this.style.display=\'none\';this.parentElement.innerHTML=\'<div style=width:100%;height:180px;background:#c41e3a;display:flex;align-items:center;justify-content:center;color:#fff;font-size:0.75rem;font-weight:700;letter-spacing:1px;text-transform:uppercase;>' + escapeHtml(article.category || 'Noticias') + '</div>\';"' +
                ' style="width:100%;height:180px;object-fit:cover;display:block;">' +
              '</a>';
        } else {
            imgHtml = '<div style="width:100%;height:180px;background:#c41e3a;display:flex;align-items:center;justify-content:center;color:#fff;font-size:0.75rem;font-weight:700;letter-spacing:1px;text-transform:uppercase;">' + escapeHtml(article.category || 'Noticias') + '</div>';
        }
...
const EMBEDDED_ARTICLES = [
  ...
  },
  {
    ...
    image: 'https://oropezas.enriquegarciaoropeza.workers.dev/api/media/articles/Noticias/maythe4thmexico.png', featuredImage: 'https://oropezas.enriquegarciaoropeza.workers.dev/api/media/articles/Noticias/maythe4thmexico.png',
